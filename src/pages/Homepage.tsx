          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-12">
              <img 
                ...
                alt="Student using printing service" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><span className="text-gray-400">Color Printing</span></li>
                <li><span className="text-gray-400">Double-Sided Printing</span></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Contact</h4>
              <ul className="space-y-2">
                <li><span className="text-gray-400">Email: support@printspark.com</span></li>
                <li><span className="text-gray-400">Phone: (123) 456-7890</span></li>
                <li><span className="text-gray-400">Location: Campus Library, Room 101</span></li>
              </ul>
            </div>
          </div>
