    ...
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link to="/" className="flex justify-center">
          <span className="font-bold text-2xl text-primary">PrintSpark Studio <span className="text-sm font-normal text-gray-500">Admin</span></span>
        </Link>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  toast({
                    ...
                    description: "You can now sign in with the demo admin account.",
                  });
                }}
